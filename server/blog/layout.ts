...
const BLOG_STYLES = `
  ...
  article.blog-post img, article.blog-post video { max-width: 100%; max-height: 85vh; width: auto; height: auto; object-fit: contain; border-radius: var(--border-radius-lg); margin: var(--spacing-3xl) auto; display: block; }
  article.blog-post iframe { width: 100%; height: 560px; max-width: 100%; max-height: 85vh; border-radius: var(--border-radius-lg); margin: var(--spacing-3xl) auto; display: block; }
